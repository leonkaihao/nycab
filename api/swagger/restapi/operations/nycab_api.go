...
func NewNycabAPI(spec *loads.Document) *NycabAPI {
	return &NycabAPI{
		...
		DeleteCabsPickupsCountCacheHandler: DeleteCabsPickupsCountCacheHandlerFunc(func(params DeleteCabsPickupsCountCacheParams) middleware.Responder {
			return middleware.NotImplemented("operation DeleteCabsPickupsCountCache has not yet been implemented")
		}),
		GetCabsPickupsCountHandler: GetCabsPickupsCountHandlerFunc(func(params GetCabsPickupsCountParams) middleware.Responder {
...
func (o *NycabAPI) Validate() error {
	...
	if o.DeleteCabsPickupsCountCacheHandler == nil {
		unregistered = append(unregistered, "DeleteCabsPickupsCountCacheHandler")
	}

	if o.GetCabsPickupsCountHandler == nil {
		unregistered = append(unregistered, "GetCabsPickupsCountHandler")
	}
...
func (o *NycabAPI) initHandlerCache() {
	...
	o.handlers["DELETE"]["/cabs/pickups/count/cache"] = NewDeleteCabsPickupsCountCache(o.context, o.DeleteCabsPickupsCountCacheHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/cabs/pickups/count"] = NewGetCabsPickupsCount(o.context, o.GetCabsPickupsCountHandler)
